...
CREATE TABLE `events` (
  ...
  `event_created` datetime NOT NULL DEFAULT '2022-02-20 00:00:00',
  `event_updated` datetime NOT NULL DEFAULT '2022-02-20 00:00:00',
...
CREATE TABLE `forum_messages` (
  ...
  `message_date` datetime DEFAULT '2022 00:00:00',
...
CREATE TABLE `forums` (
  ...
  `forum_create_date` datetime DEFAULT '2022-01-01 00:00:00',
  `forum_last_date` datetime DEFAULT '2022-01-01 00:00:00',
...
CREATE TABLE `history` (
  ...
  `history_date` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
...
CREATE TABLE `old_projects` (
  ...
  `project_created` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
  `project_updated` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
...
CREATE TABLE `old_user_access_log` (
  ...
  `date_time_in` datetime DEFAULT '2022-01-01 00:00:00',
  `date_time_out` datetime DEFAULT '2022-01-01 00:00:00',
  `date_time_last_action` datetime DEFAULT '2022-01-01 00:00:00',
...
CREATE TABLE `sessions` (
  ...
  `session_created` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
...
CREATE TABLE `task_log` (
  ...
  `task_log_created` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
  `task_log_updator` int(10) NOT NULL DEFAULT 0,
  `task_log_updated` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
...
CREATE TABLE `tasks` (
  ...
  `task_created` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
  `task_updated` datetime NOT NULL DEFAULT '2020-01-01 00:00:00',
